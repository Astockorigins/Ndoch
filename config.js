...
window.CONFIG = {
  PROXY_URL: "https://// Gold Sniper v2.6.2 Config (GitHub Pages safe)
window.CONFIG = {
  ...
  // LITE mode reduces API calls to avoid rate limits
  LITE_MODE: true,
  ...
  // Gold Strength Chart (M15) – how many M15 candles to draw
  CHART_M15_BARS: 24
};.dvdndng.workers.dev",
  USD_PROXY_SYMBOL: "EUR/USD",
  GOLD_SYMBOL: "XAU/USD",
